...
import { submitContactForm } from "../utils/submitContactForm"; // make sure this path is correct
...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col items-center justify-center px-6 bg-gradient-to-br from-indigo-900 via-blue-900 to-gray-900 relative py-12"
    >
      <div className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        ...
        >
          ...
          <motion.p className="text-gray-300 mt-4 text-lg italic">
            {subtext}
          </motion.p>
