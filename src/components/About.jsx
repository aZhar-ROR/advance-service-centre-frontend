        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <p className="text-gray-700 text-lg">
                Specializing in{" "}
                <strong>LED TVs, ACs, and Geysers</strong> with precision
                repairs.
              </p>
            </div>
            <div className="flex items-center gap-3">
          ...
          >
            ...
            <p className="text-gray-600 mt-2 text-lg">
              We specialize in servicing top brands for TVs, ACs, and Washing
              Machines.
            </p>
            ...
            <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
              {brands.map((brand, index) => (
                <motion.div
                  ...
                  className="flex items-center justify-center h-20 bg-white text-gray-800 font-semibold text-lg rounded-lg border shadow-sm p-4 text-center"
                >
                  {brand}
                </motion.div>
              ))}
