    ...
    <div>
      <section className="min-h-[100vh] flex flex-col items-center justify-center px-2 sm:px-6 py-8 sm:py-16 bg-gradient-to-br from-indigo-900 via-blue-900 to-gray-900 text-white">
        <div className="container mx-auto flex flex-col items-center justify-center">
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold text-yellow-400 mb-4 sm:mb-6 leading-tight drop-shadow-lg text-center">TV Repair Services in Hooghly</h1>
          <p className="text-base sm:text-lg md:text-xl mb-4 sm:mb-6 max-w-2xl mx-auto text-white/90 text-center">
            Fast, reliable LED TV repairs & installation for all major brands. Serving Hooghly with expert technicians and guaranteed satisfaction.
          </p>
          <p className="text-sm sm:text-base md:text-lg mb-4 sm:mb-6 max-w-2xl mx-auto text-blue-100 text-center">
            Searching for TV repair in Hooghly? Our skilled team offers doorstep LED, LCD, and Smart TV repairs for all top brands. We serve every area in Hooghly with quick response, genuine parts, and affordable rates. Whether your TV has display, sound, or connectivity issues, we provide expert solutions and a satisfaction guarantee. Book your TV repair in Hooghly today for professional service and peace of mind.
          </p>
          <img src={heroImage} alt="TV Repair Hooghly" className="mx-auto w-full max-w-xs sm:max-w-md h-32 sm:h-40 md:h-56 lg:h-64 object-contain rounded-xl shadow-2xl border-4 border-yellow-500 mb-4 sm:mb-6" />
...
export default TVRepairHooghly;
